...
# reading csv file
ddf = pd.read_csv("/home/vinay/MED-TRAINING/Task 03/EmployeeMeetingScheduler.csv")
#print(df)
...
while int(input("Want to schedule a new meet \n Enter 0 or 1 : \n")):
    ...
    if confirm:
        ...
        #mdf.to_csv("/home/vinay/MED-TRAINING/Task 03/Meeting.csv", index=False) #writing the dataframe into csv
