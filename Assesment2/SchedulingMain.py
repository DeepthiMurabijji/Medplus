...
# TODO: The below data need to come from CSV File
...
while True:
    ...
    meetingDuration = input("Duration of meeting: ")
    ...
    while True:
        ...
        if maxTimeCounter == len(employeeInputList):
            for x in employeeInputList:
                ...
                if c == 0:
                    print("Meeting is booked from {} to {}".format(
        ...
        # TODO: The Above Meetings data need to be writtin in a CSV File
        header = ['employees','from','to']
        data=[employeeInputList,temp[0],temp[1]]
        #data=[['Alex',80,'B'],['Brad',45,'C'],['Joey',89,'A'],['jinx',98,'O']]
        filename = 'scheduledMet.csv'
    ...
    #     temp = []
    #     for y in range(1):
    #         temp.append(collectMax)
    #         temp.append(collectMax+meetingDurationConverted)
    ...
    # printingMeetingsTimeline = meetingsTimeline

    # for x in employeeInputList:
    #     for y in range(len(meetingsTimeline[x])):
    #         for z in range(len(meetingsTimeline[x][y])):
    #             printingMeetingsTimeline[x][y][z] = minutesToHours(meetingsTimeline[x][y][z])
